...
export const ru: Translations = {
  ...
  sidebar: {
    ...
    discoveredHint: 'Нажмите на устройство, чтобы выполнить сопряжение.',
    pairModalTitle: 'Сопряжение устройства',
    pairModalNotReadyTitle: 'Пока не готово к сопряжению',
    pairModalNotReadyBody: 'Это устройство ещё не на экране сопряжения. На телефоне откройте «Отладка по Wi-Fi» > «Сопряжение через код», и оно появится здесь готовым к сопряжению.',
    pairModalWaiting: 'Проверка экрана сопряжения...',
    pairModalError: 'Сопряжение не удалось. Проверьте код и попробуйте снова.',
    clear: 'Очистить',
  ...
  logs: {
    ...
    connectionStaleTip: '[СОВЕТ] Порт может быть устаревшим, или устройство ещё не сопряжено с этим ПК.\nВыполните повторное сопряжение ниже или «Остановить ADB», чтобы обновить.',
